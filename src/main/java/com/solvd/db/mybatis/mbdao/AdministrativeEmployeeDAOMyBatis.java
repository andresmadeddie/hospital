...
public class AdministrativeEmployeeDAOMyBatis implements IAdministrativeEmployeeDAO {
        ...
        try (PreparedStatement ps = con.prepareStatement(query)) {
            ...
            try (ResultSet rs = ps.getResultSet()) {
                while (rs.next()) {
                    ...
                    administrativeEmployee.setPerson(new PersonDAOMyBatis().getById(rs.getInt("person_id")));
